                        ...
                        <div className='col-lg-6'>
                            <div className='p-3 bg-light rounded-3'>
                                <div className='py-3 border-bottom'>
                                    <p className=' fs-4 fw-bold text-capitalize'>({quantity}x) {name} - ₱{price}</p>
                                    <p className='fs-4 mb-0 fw-bold'>Lens Upgrade</p>
                                    <p className='fs-4'>{lensUpgrade} - ₱{lensUpgradePrice}</p>
