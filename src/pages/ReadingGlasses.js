...
export const ReadingGlasses = () => {
    ...
    const fetchDataByCategory = async (category) => {
        try {
            const res = await fetch(`${process.env.REACT_APP_API_URL}/products/category/reading`, {
                method: "GET",
                headers: {
    ...
    const searchProduct = async (category) => {
        try {
            const res = await fetch(`${process.env.REACT_APP_API_URL}/products/category/reading/search?searchTerm=${searchTerm}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                }
